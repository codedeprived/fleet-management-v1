                ...
                <ul className="space-y-2 font-medium">
                    <li>
                        <button
                            ...
                            className="flex items-center w-full text-left p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                        >
                            <svg
                        ...
                        >
                            ...
                            >
                                <path
                                    ...
                                    strokeWidth="2"
                                    d="M1 8h11m0 0L8 4m4 4-4 4m4-11h3a2 2 0 0 1 2 2v10a2 ```javascript
                    2 0 0 1-2 2h-3"
                                />
                            </svg>
