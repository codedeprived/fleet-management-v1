        ...
        <div className="relative z-10 text-center text-white bg-white bg-opacity-10 backdrop-blur-lg p-8 rounded-xl shadow-2xl border border-white border-opacity-30 font-roboto ">
          ...
          <div className="space-x-4">
            ...
            onClick={() => navigate("/registration")}
              className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-lg px-8 py-3 text-center me-2 mb-2 font"
            >
              Sign Up
            </button>
            <button
            ...
            //    onClick={() => navigate("/")}
              ...
              <button
            //    onClick={() => navigate("/")}
                className="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-lg px-8 py-3 text-center me-2 mb-2"
              >
                Admin Login
              </button>
              </div>
